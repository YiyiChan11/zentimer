...
export const zh: Record<string, string> = {
  ...
  windowsVersion: 'Windows 桌面端',
  windowsVersionSub: 'Tauri · 轻量原生',
  androidVersion: 'Android',
  androidVersionSub: 'APK · 移动原生',
  featureNoInstall: '打开即用',
  featureInstallable: '可安装到桌面',
  featureAutoUpdate: '自动更新',
  featureCrossPlatform: '跨平台',
  featureAlwaysOnTop: '悬浮窗置顶',
  featureSystemTray: '系统托盘',
  featureOffline: '离线使用',
  featureLightweight: '极低占用',
  featureFloatingNotify: '悬浮通知',
  featureBackground: '后台计时',
  featureLockScreen: '锁屏提醒',
  featureWidget: '小部件',
  recommended: '推荐',
  comingSoon: '即将推出',
  useWebVersion: '使用网页版',
