...
export const en: Record<string, string> = {
  ...
  download: 'Download',
  runningNow: 'Running',
  openInstantly: 'Ready to use',
  installToDesktop: 'Install to desktop',
  autoUpdate: 'Auto-update',
  crossPlatform: 'Cross-platform',
  floatingOnTop: 'Always-on-top',
  systemTray: 'System tray',
  offlineUse: 'Works offline',
  lowFootprint: 'Tiny footprint',
  floatingNotification: 'Floating notification',
  backgroundTimer: 'Background timer',
  lockScreenReminder: 'Lock screen alert',
  widget: 'Home widget',
  backToTimer: 'Back to Timer',

  // PWA install hint
  pwaInstallTitle: 'How to install the web app to your desktop?',
